...
*
* @version  $Id: ModelFactory.php,v 1.13 2006/06/26 10:57:06 tgauss Exp $
...
class ModelFactory
{
    ...
    */
	function & getDatasetMem($graphSetId = null)
	{
		...
		return new DatasetMem($graphSetId);
	}
	...
	*/
	function & getSparqlClient($server){
		return new SparqlClient($server);
	}
}  
?>
